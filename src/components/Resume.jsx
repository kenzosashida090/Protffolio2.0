...
import { FaNodeJs, FaRegFilePdf } from "react-icons/fa6";
...
const Resume =  ()=> {
    return (
         <section id='resume' className=' flex gap-11 space-y-24  p-x justify-center h-[80vh] transition-colors duration-500 ease-in-out mx-auto overflow-y-auto'>
                        ...
                        <div className="pt-4 text-center sm:text-left">
                          ...
                          <FaRegFilePdf className="font-bol text-xl text-slate-900  dark:text-white"/>
                          </div>
                        ...
                        <div className="flex w-full flex-col items-start pt-4 ">
                            <div className="group flex gap-x-6">
                                ...
                                <p className="font-sans text-base font-bold  text-slate-800 antialiased dark:text-white">Jr Front-end developer.</p><small className="mt-2 font-sans text-sm text-slate-600 antialiased">The key to more success is to have a lot of pillows. Put it this way, it took me twenty five years to get these plants, twenty five years of blood sweat and tears, and I&#x27;m never giving up, I&#x27;m just getting started. I&#x27;m up to something. Fan luv.</small>
                                </div>
                            </div>
                            <div className="group flex gap-x-6">
                                <div className="relative">
