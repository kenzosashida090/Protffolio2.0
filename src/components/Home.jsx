...
// };
    return (
              ...
              id='home' className=' flex gap-11 space-y-24  px-10 justify-center min-h-[80vh] transition-colors duration-500 ease-in-out mx-auto '>
                <div 
                  

                  className="flex flex-col gap-4 ">
                <h1
                  className="sm:text-7xl text-5xl text-center  font-sans ">
                  Hi!, I&apos;m <span className='font-bold sm:text-7xl text-6xl text-slate-700 dark:text-slate-300 '>Kenzo</span>.
                </h1>
                ...
                <div className="border-2 w-72 dark:border-indigo-200/20 flex border-slate-500/40 mt-2 ml-2 items-end justify-end "></div>

                <div 
                  className="pt-4 px-2 flex-col space-y-2">
                ...
                <div 
                     className="pt-4 text-center sm:text-left px-2 ">
