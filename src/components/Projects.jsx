...
function Projects() {
    ...
    return (
        <section id="projects" className="min-h-screen text-center">
            <h1 className="text-5xl vibrate">Projects</h1>
            ...
            <div  className="flex items-center justify-center flex-col space-y-7">
                    ...
                    <Slide cascade>
                        ...
                        <Fade cascade delay={1200} damping={0.02}>
                          <button className="text-slate-50 flex border-lime-300 border-10 bg-slate-500 p-2 mt-9 items-center justify-center space-x-2"> 
                            ...
                            <sapn><a href="https://github.com/AbdulrahmanAlsharif/">Code</a></sapn>
                          </button>
                        </Fade>
                    </Slide>
                  </div>
               ...
               <IoCodeSlashOutline size={20}/>
               <sapn>
                 <a href="https://github.com/AbdulrahmanAlsharif/">Code</a>
               </sapn>
               </button>
               </Fade>
               </Slide>
