...
<header className="flex items-center justify-evenly bg-slate-200 px-10 sticky top-0 dark:bg-slate-800 transition-colors duration-500 ease-in-out">
    <ul className="flex items-center space-x-20 text-2xl my-10 mr-5" onClick={(e) => {
        e.preventDefault();
    ...
    <ul className="flex items-center space-x-20 text-2xl my-10  " onClick={(e) => {
        ...
        <li className="vibrate text-slate-800 dark:text-slate-50 hidden md:block"><a href="#projects">Projects</a></li>
        <li className="vibrate text-slate-800 dark:text-slate-50"><a href="#contact">Contact</a></li>
        <li className="vibrate text-slate-800 dark:text-slate-50"><a href="#contact">Blog</a></li>
        <li className="hidden md:block"><DarkModeToggle/></li>
    </ul>
</header>
    )
}
